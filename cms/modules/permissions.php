...
class PermissionsController
{
    ...
    public function getConfig() {
        $q = $this->db->query('SELECT * FROM `themagescms` WHERE `setting` = "menu" OR `setting` = "max_level"');
        $q->execute();
    ...
    public function updatePermissions($attributes) {
        ...
        $q = $this->db->prepare('UPDATE `themagescms` SET `value` = :value WHERE `setting` = "menu"');
